...
#define _mm_castsi128_ps sg_bitcast_pi32_ps
#define _mm_castps_si128 sg_bitcast_ps_pi32
#define _mm_castsi128_pd sg_bitcast_pi32_pd
#define _mm_castpd_si128 sg_bitcast_pd_pi32
#define _mm_castps_pd sg_bitcast_ps_pd
#define _mm_castpd_ps sg_bitcast_pd_ps
...
#define _mm_set1_epi64x(a) sg_bitcast_pi64_pi32(sg_set1_pi64(a))
...
#define _mm_set_epi64x(si1, si0) sg_bitcast_pi64_pi32(sg_set_pi64(si1, si0))
#define _mm_set_ps sg_set_ps
#define _mm_set_pd sg_set_pd
#define _mm_cvtsi128_si32 sg_get0_pi32
#define _mm_cvtsi128_si64(a) sg_get0_pi64(sg_bitcast_pi32_pi64(a))
...
#define _mm_unpackhi_epi64(a, b) sg_bitcast_pi64_pi32(vcombine_s64( \
    vget_high_s64(sg_bitcast_pi32_pi64(a)), \
    vget_high_s64(sg_bitcast_pi32_pi64(b))))
#define _mm_add_epi32 sg_add_pi32
#define _mm_add_epi64(a, b) sg_bitcast_pi64_pi32( \
    sg_add_pi64(sg_bitcast_pi32_pi64(a), sg_bitcast_pi32_pi64(b)))
#define _mm_add_ps sg_add_ps
#define _mm_add_pd sg_add_pd
#define _mm_sub_epi32 sg_sub_pi32
#define _mm_sub_epi64(a, b) sg_bitcast_pi64_pi32( \
    sg_sub_pi64(sg_bitcast_pi32_pi64(a), sg_bitcast_pi32_pi64(b)))
...
#define _mm_slli_epi64(a, imm) sg_bitcast_pi64_pi32( \
    sg_sl_imm_pi64(sg_bitcast_pi32_pi64(a), imm))
#define _mm_srli_epi32 sg_srl_imm_pi32
#define _mm_srli_epi64(a, imm) sg_bitcast_pi64_pi32(sg_srl_imm_pi64( \
    sg_bitcast_pi32_pi64(a), imm))
